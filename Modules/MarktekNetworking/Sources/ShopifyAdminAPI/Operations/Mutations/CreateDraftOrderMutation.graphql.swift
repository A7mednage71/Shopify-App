...
public class CreateDraftOrderMutation: GraphQLMutation {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation CreateDraftOrder($input: DraftOrderInput!) { draftOrderCreate(input: $input) { __typename draftOrder { __typename id name totalPrice } userErrors { __typename field message } } }"#
    ))
